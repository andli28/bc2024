...
def run_match(bot, map, toAddWins):
    ...
    try:
        with concurrent.futures.ProcessPoolExecutor() as executor:
            future_to_outputA = executor.submit(run_subprocess, currentBot, bot, map)
            future_to_outputB = executor.submit(run_subprocess, bot, currentBot, map)

            outputA = future_to_outputA.result()
            outputB = future_to_outputB.result()
